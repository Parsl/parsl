...
config_local_test: ## run all tests with workqueue_ex config
	...
	PYTHONPATH=. pytest parsl/tests/test_threads/test_configs.py parsl/tests/sites/test_local_adhoc.py parsl/tests/test_regression/test_854.py parsl/tests/test_regression/test_1480.py parsl/tests/sites/test_dynamic_executor.py parsl/tests/test_error_handling/test_htex_basic.py parsl/tests/sites/test_worker_info.py parsl/tests/test_monitoring/test_fuzz_zmq.py parsl/tests/test_threads/test_lazy_errors.py parsl/tests/test_regression/test_1653.py parsl/tests/test_staging/test_1316.py parsl/tests/sites/test_affinity.py parsl/tests/test_flowcontrol/test_one_block.py parsl/tests/test_staging/test_elaborate_noop_file.py parsl/tests/test_checkpointing/test_task_exit.py parsl/tests/test_providers/test_local_provider.py parsl/tests/test_error_handling/test_retries.py parsl/tests/test_python_apps/test_memoize_2.py parsl/tests/test_error_handling/test_serialization_fail.py parsl/tests/test_error_handling/test_htex_worker_failure.py parsl/tests/test_error_handling/test_wrap_with_logs.py parsl/tests/test_checkpointing/test_periodic.py parsl/tests/test_summary.py parsl/tests/test_regression/test_98.py parsl/tests/sites/test_local_exex.py parsl/tests/test_checkpointing/test_python_checkpoint_2.py parsl/tests/test_regression/test_221.py parsl/tests/site_tests/test_provider.py parsl/tests/test_data/test_file.py parsl/tests/test_staging/test_docs_2.py -k "not cleannet" --config local --cov=parsl --cov-append --cov-report= --random-order
