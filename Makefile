...
radical_local_test:
	pytest parsl/tests/ -k "not cleannet and not dynamically_loaded_module and not test_check_importlib_file_function and not test_apptimeout and not test_parallel_for" --config parsl/tests/configs/local_radical.py --durations 10
