...
config_local_test: ## run all tests with workqueue_ex config
	...
	PYTHONPATH=. pytest parsl/tests/test_threads/test_configs.py parsl/tests/sites/test_local_adhoc.py parsl/tests/test_regression/test_854.py parsl/tests/test_error_handling/test_htex_basic.py parsl/tests/sites/test_affinity.py parsl/tests/test_error_handling/test_serialization_fail.py parsl/tests/test_regression/test_221.py parsl/tests/test_data/test_file.py -k "not cleannet" --config local --cov=parsl --cov-append --cov-report= --random-order
