...
radical_local_test:
	pytest parsl/tests/ -k "not cleannet and not issue363 and not dynamically_loaded_module and not test_check_importlib_file_function" --config parsl/tests/configs/local_radical.py --random-order --durations 10
