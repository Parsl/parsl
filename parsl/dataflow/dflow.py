...
class DataFlowKernel:
    ...
    def launch_task(self, task_record: TaskRecord) -> Future:
        ...
        if self.monitoring is not None and self.monitoring.resource_monitoring_enabled and executor.remote_monitoring_radio_config:
            # TODO: should raise an error at some monitoring initialization time to
            # see if we have asked for resource monitoring without supplying a radio config?
    ...
    def add_executors(self, executors: Sequence[ParslExecutor]) -> None:
        for executor in executors:
            ...
            if self.monitoring and executor.remote_monitoring_radio_config is not None:
                ...
                executor.monitoring_receiver = executor.remote_monitoring_radio_config.create_receiver(
                                                                              resource_msgs=executor.monitoring_messages,
