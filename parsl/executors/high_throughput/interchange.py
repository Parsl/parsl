...
class Interchange:
    ...
    def start(self) -> None:
        ...
        while not kill_event.is_set():
            ...
            self.process_worker_socket_message(interesting_managers, monitoring_radio, kill_event)
    ...
    def process_worker_socket_message(
        self,
        ...
        """
        if self.socks.get(self.worker_sock) == zmq.POLLIN:
