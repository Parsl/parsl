...
class ParslExecutor(metaclass=ABCMeta):
    ...
    The data flow kernel will set:

        monitoring_messages: Optional[Queue[TaggedMonitoringMessage]] - if monitoring is
            to be enabled, before calling .start()

    TODO: document submit_monitoring_radio here too
