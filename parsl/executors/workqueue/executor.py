...
needs = 'id category cores memory disk gpus priority running_time_min env_pkg map_file function_file result_file input_files output_files'
ParslTaskToWq = namedtuple('ParslTaskToWq', needs)
