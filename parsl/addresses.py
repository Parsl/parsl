...
def address_by_route() -> str:
    """Finds an address for the local host by querying the local routing table
       ...
       This will return an incorrect value when the internet-facing address is
...
def address_by_query() -> str:
    """Finds an address for the local host by querying ipify. This will
       return an incorrect value when the host is behind NAT, or when the
...
def address_by_hostname() -> str:
    """Returns the hostname of the local host.
       ...
       This will return an incorrect value when the hostname cannot be
       resolved correctly from workers.
    """
