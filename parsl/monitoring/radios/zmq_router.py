...
def start_zmq_router(*,
                     monitoring_messages: QueueType,
                     loopback_address: str,
                     port_range: Tuple[int, int],
                     logdir: str,
                     worker_debug: bool) -> Tuple[ForkProcessType, EventType, int]:
    # TODO: close queue
    zmq_comm_q = SizedQueue(maxsize=10)

    # TODO: do this shutdown
    zmq_router_exit_event = Event()

    zmq_router_proc = ForkProcess(target=zmq_router_starter,
                                  kwargs={"comm_q": zmq_comm_q,
                                          "resource_msgs": monitoring_messages,
                                          "exit_event": zmq_router_exit_event,
    ...
    # TODO: ripe for turning into a local object as part of plugin work
    return (zmq_router_proc, zmq_router_exit_event, zmq_comm_q_result)
