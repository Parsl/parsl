    ...
    def setup(self, args):
        return [dcc.RadioItems(id='memory_usage_distribution_radio_items',
                               options=[{'label': 'Average', 'value': 'avg'},
                                        {'label': 'Max', 'value': 'max'}],
                               value='avg'),
                html.Label(htmlFor='memory_usage_distribution_columns', children='Columns'),
    ...
    def setup(self, args):
        return [dcc.RadioItems(id='virtual_memory_distribution_radio_items',
                               options=[{'label': 'Average', 'value': 'avg'},
                                        {'label': 'Max', 'value': 'max'}],
                               value='avg'),
                html.Label(htmlFor='virtual_memory_distribution_columns', children='Columns'),
    ...
    def setup(self, args):
        return [dcc.RadioItems(id='resident_memory_distribution_radio_items',
                               options=[{'label': 'Average', 'value': 'avg'},
                                        {'label': 'Max', 'value': 'max'}],
                               value='avg'),
                html.Label(htmlFor='resident_memory_distribution_columns', children='Columns'),
